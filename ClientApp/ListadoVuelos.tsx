import { Vuelos } from "./BuscadorVuelos";
...
const ListadoVuelos = ({vuelos}: Props) => {
    ...
    const formatoHora = (fecha: string) => {
        const formato = new Intl.DateTimeFormat("es-MX", {hour: "2-digit", minute: "2-digit"});
        const dt = new Date(fecha);
